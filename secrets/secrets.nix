let
  ...
  dedistonks2 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIK8ibMkBamhbgmyHRXKPKULWD1u2qmCmbyjQ6z16Ruwi vagahbond@dedistonks2";
in {
  # Wifi passwords
  "wifi.age".publicKeys = [framework blade];
  "kubeconfig.age".publicKeys = [framework blade];
  "ssh_config.age".publicKeys = [framework blade];
  "wakatime_config.age".publicKeys = [framework blade dedistonks dedistonks2];
  "nextcloud_admin_pass.age".publicKeys = [framework dedistonks dedistonks2];
