{
  ...
  regular4=${mkHex colors.base0C}  # blue (Foam)
  regular5=${mkHex colors.base0D}  # magenta (Iris)
  regular6=${mkHex colors.base0A}  # cyan (Rose)
  regular7=${mkHex colors.text}    # white (Text)

  bright0=${mkHex colors.base03} # bright black (Overlay)
  bright1=${mkHex colors.base08} # bright red (Love)
  bright2=${mkHex colors.base0B} # bright green (Pine)
  bright3=${mkHex colors.base09} # bright yellow (Gold)
  bright4=${mkHex colors.base0C} # bright blue (Foam)
  bright5=${mkHex colors.base0D} # bright magenta (Iris)
  bright6=${mkHex colors.base0A} # bright cyan (Rose)
